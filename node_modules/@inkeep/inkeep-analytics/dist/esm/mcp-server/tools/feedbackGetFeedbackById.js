...
export const tool$feedbackGetFeedbackById = {
    name: "feedback-get-feedback-by-id",
    description: `Get Feedback by ID`,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await feedbackGetFeedbackById(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {

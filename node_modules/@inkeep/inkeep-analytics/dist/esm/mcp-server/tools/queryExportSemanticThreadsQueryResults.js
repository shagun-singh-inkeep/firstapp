...
export const tool$queryExportSemanticThreadsQueryResults = {
    name: "query-export-semantic-threads-query-results",
    description: `Export Semantic Threads Query Results`,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await queryExportSemanticThreadsQueryResults(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {

...
export const tool$conversationGetConversationByExternalId = {
    name: "conversation-get-conversation-by-external-id",
    description: `Get Conversation by External ID`,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await conversationGetConversationByExternalId(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {

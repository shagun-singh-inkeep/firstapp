 ...
 * Log Event
 */
export function eventsLog(client, security, request, options) {
    return new APIPromise($do(client, security, request, options));
}
async function $do(client, security, request, options) {
    const parsed = safeParse(request, (value) => components.InsertEvent$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {

...
exports.queryExportSemanticThreadsQueryResults = queryExportSemanticThreadsQueryResults;
 ...
 */
function queryExportSemanticThreadsQueryResults(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = (0, url_js_1.pathToFunc)("/query/semantic-threads/export")();

...
exports.tool$feedbackGetFeedbackById = void 0;
...
exports.tool$feedbackGetFeedbackById = {
    name: "feedback-get-feedback-by-id",
    description: `Get Feedback by ID`,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, feedbackGetFeedbackById_js_1.feedbackGetFeedbackById)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {

...
exports.tool$feedbackList = void 0;
...
exports.tool$feedbackList = {
    name: "feedback-list",
    description: `Get All Feedback`,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, feedbackList_js_1.feedbackList)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {

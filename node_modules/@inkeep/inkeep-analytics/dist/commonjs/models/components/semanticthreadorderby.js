...
exports.SemanticThreadOrderBy$ = exports.SemanticThreadOrderBy$outboundSchema = exports.SemanticThreadOrderBy$inboundSchema = exports.SemanticThreadOrderByDirection$ = exports.SemanticThreadOrderByDirection$outboundSchema = exports.SemanticThreadOrderByDirection$inboundSchema = exports.SemanticThreadOrderByField$ = exports.SemanticThreadOrderByField$outboundSchema = exports.SemanticThreadOrderByField$inboundSchema = exports.SemanticThreadOrderByDirection = exports.SemanticThreadOrderByField = void 0;
exports.semanticThreadOrderByToJSON = semanticThreadOrderByToJSON;
exports.semanticThreadOrderByFromJSON = semanticThreadOrderByFromJSON;
const z = __importStar(require("zod"));
const schemas_js_1 = require("../../lib/schemas.js");
exports.SemanticThreadOrderByField = {
    Id: "id",
...
/** @internal */
exports.SemanticThreadOrderByField$inboundSchema = z.nativeEnum(exports.SemanticThreadOrderByField);
/** @internal */
exports.SemanticThreadOrderByField$outboundSchema = exports.SemanticThreadOrderByField$inboundSchema;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var SemanticThreadOrderByField$;
(function (SemanticThreadOrderByField$) {
    /** @deprecated use `SemanticThreadOrderByField$inboundSchema` instead. */
    SemanticThreadOrderByField$.inboundSchema = exports.SemanticThreadOrderByField$inboundSchema;
    /** @deprecated use `SemanticThreadOrderByField$outboundSchema` instead. */
    SemanticThreadOrderByField$.outboundSchema = exports.SemanticThreadOrderByField$outboundSchema;
})(SemanticThreadOrderByField$ || (exports.SemanticThreadOrderByField$ = SemanticThreadOrderByField$ = {}));
/** @internal */
exports.SemanticThreadOrderByDirection$inboundSchema = z.nativeEnum(exports.SemanticThreadOrderByDirection);
/** @internal */
exports.SemanticThreadOrderByDirection$outboundSchema = exports.SemanticThreadOrderByDirection$inboundSchema;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var SemanticThreadOrderByDirection$;
(function (SemanticThreadOrderByDirection$) {
    /** @deprecated use `SemanticThreadOrderByDirection$inboundSchema` instead. */
    SemanticThreadOrderByDirection$.inboundSchema = exports.SemanticThreadOrderByDirection$inboundSchema;
    /** @deprecated use `SemanticThreadOrderByDirection$outboundSchema` instead. */
    SemanticThreadOrderByDirection$.outboundSchema = exports.SemanticThreadOrderByDirection$outboundSchema;
})(SemanticThreadOrderByDirection$ || (exports.SemanticThreadOrderByDirection$ = SemanticThreadOrderByDirection$ = {}));
/** @internal */
exports.SemanticThreadOrderBy$inboundSchema = z.object({
    field: exports.SemanticThreadOrderByField$inboundSchema,
    direction: exports.SemanticThreadOrderByDirection$inboundSchema,
});
/** @internal */
exports.SemanticThreadOrderBy$outboundSchema = z.object({
    field: exports.SemanticThreadOrderByField$outboundSchema,
    direction: exports.SemanticThreadOrderByDirection$outboundSchema,
});
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var SemanticThreadOrderBy$;
(function (SemanticThreadOrderBy$) {
    /** @deprecated use `SemanticThreadOrderBy$inboundSchema` instead. */
    SemanticThreadOrderBy$.inboundSchema = exports.SemanticThreadOrderBy$inboundSchema;
    /** @deprecated use `SemanticThreadOrderBy$outboundSchema` instead. */
    SemanticThreadOrderBy$.outboundSchema = exports.SemanticThreadOrderBy$outboundSchema;
})(SemanticThreadOrderBy$ || (exports.SemanticThreadOrderBy$ = SemanticThreadOrderBy$ = {}));
function semanticThreadOrderByToJSON(semanticThreadOrderBy) {
    return JSON.stringify(exports.SemanticThreadOrderBy$outboundSchema.parse(semanticThreadOrderBy));
}
function semanticThreadOrderByFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.SemanticThreadOrderBy$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'SemanticThreadOrderBy' from JSON`);
}

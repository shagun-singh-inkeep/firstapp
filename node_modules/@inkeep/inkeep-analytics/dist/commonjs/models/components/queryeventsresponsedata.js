...
exports.QueryEventsResponseData$ = exports.QueryEventsResponseData$outboundSchema = exports.QueryEventsResponseData$inboundSchema = exports.EventsResultItem$ = exports.EventsResultItem$outboundSchema = exports.EventsResultItem$inboundSchema = void 0;
exports.eventsResultItemToJSON = eventsResultItemToJSON;
exports.eventsResultItemFromJSON = eventsResultItemFromJSON;
exports.queryEventsResponseDataToJSON = queryEventsResponseDataToJSON;
exports.queryEventsResponseDataFromJSON = queryEventsResponseDataFromJSON;
const z = __importStar(require("zod"));
const primitives_js_1 = require("../../lib/primitives.js");
const schemas_js_1 = require("../../lib/schemas.js");
/** @internal */
exports.EventsResultItem$inboundSchema = z.object({
...
/** @internal */
exports.EventsResultItem$outboundSchema = z.object({
    id: z.string().optional(),
    organizationId: z.string().optional(),
    messageId: z.string().optional(),
    conversationId: z.string().optional(),
 ...
 */
var EventsResultItem$;
(function (EventsResultItem$) {
    /** @deprecated use `EventsResultItem$inboundSchema` instead. */
    EventsResultItem$.inboundSchema = exports.EventsResultItem$inboundSchema;
    /** @deprecated use `EventsResultItem$outboundSchema` instead. */
    EventsResultItem$.outboundSchema = exports.EventsResultItem$outboundSchema;
})(EventsResultItem$ || (exports.EventsResultItem$ = EventsResultItem$ = {}));
function eventsResultItemToJSON(eventsResultItem) {
    return JSON.stringify(exports.EventsResultItem$outboundSchema.parse(eventsResultItem));
}
function eventsResultItemFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.EventsResultItem$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'EventsResultItem' from JSON`);
}
/** @internal */
exports.QueryEventsResponseData$inboundSchema = z.object({
    result: z.array(z.lazy(() => exports.EventsResultItem$inboundSchema)),
    total: z.number(),
    pageSize: z.number(),
    count: z.number(),
});
/** @internal */
exports.QueryEventsResponseData$outboundSchema = z.object({
    result: z.array(z.lazy(() => exports.EventsResultItem$outboundSchema)),
    total: z.number(),
    pageSize: z.number(),
    count: z.number(),
});
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var QueryEventsResponseData$;
(function (QueryEventsResponseData$) {
    /** @deprecated use `QueryEventsResponseData$inboundSchema` instead. */
    QueryEventsResponseData$.inboundSchema = exports.QueryEventsResponseData$inboundSchema;
    /** @deprecated use `QueryEventsResponseData$outboundSchema` instead. */
    QueryEventsResponseData$.outboundSchema = exports.QueryEventsResponseData$outboundSchema;
})(QueryEventsResponseData$ || (exports.QueryEventsResponseData$ = QueryEventsResponseData$ = {}));
function queryEventsResponseDataToJSON(queryEventsResponseData) {
    return JSON.stringify(exports.QueryEventsResponseData$outboundSchema.parse(queryEventsResponseData));
}
function queryEventsResponseDataFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.QueryEventsResponseData$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'QueryEventsResponseData' from JSON`);
}

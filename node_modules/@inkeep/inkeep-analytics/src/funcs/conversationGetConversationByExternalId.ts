 ...
 */
export function conversationGetConversationByExternalId(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetConversationByExternalIdRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    externalId: encodeSimple("externalId", payload.externalId, {
      explode: false,
      charEncoding: "percent",
    }),
  };

  const path = pathToFunc("/conversations/external/{externalId}")(pathParams);

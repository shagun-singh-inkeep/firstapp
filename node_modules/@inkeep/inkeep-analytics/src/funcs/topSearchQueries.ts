...
> {
  const parsed = safeParse(
    request,
    (value) => operations.TopSearchQueriesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/query/top-search-queries")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TopSearchQueriesResponseBody$inboundSchema),

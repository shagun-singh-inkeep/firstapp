...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetFeedbackByIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/feedback/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetFeedbackByIdResponseBody$inboundSchema),

 ...
 * Query Feedback
 */
export function queryQueryFeedback(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.QueryFeedbackRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/query/feedback")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.QueryFeedbackResponseBody$inboundSchema),

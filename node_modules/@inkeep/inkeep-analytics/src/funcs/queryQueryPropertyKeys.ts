...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.PropertyKeysRequestBody$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/query/property-keys")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.PropertyKeysResponseBody$inboundSchema),

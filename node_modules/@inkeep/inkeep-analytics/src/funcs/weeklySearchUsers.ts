 ...
 * Weekly Search Users
 */
export function weeklySearchUsers(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.WeeklySearchUsersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/query/weekly-search-users")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.WeeklySearchUsersResponseBody$inboundSchema),
